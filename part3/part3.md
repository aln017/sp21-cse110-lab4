1. The bug was that calculateSum was concatenating the two numbers together as a string rather than adding them since they were both passed in as strings.
